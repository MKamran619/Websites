...
('services', 'Services - Digital Transformation, Cloud Migration & Custom Development', $txt$Professional software development services including digital transformation, custom development, cloud migration, legacy modernization, and technical consulting.$txt$, 'software development services, digital transformation, cloud migration, legacy modernization, custom development, technical consulting', 'https://nexawebservice.com/assets/services-og-image.jpg'),
...
('courses', 'Web Development Courses | Learn HTML, CSS, JavaScript, Angular, React', $txt$Comprehensive web development courses from beginner to advanced. Master HTML, CSS, Bootstrap, JavaScript, jQuery, Angular, React, and Full Stack Development.$txt$, 'web development courses, learn coding, JavaScript courses, Angular courses, React courses, Bootstrap courses, jQuery, HTML CSS', 'https://nexawebservice.com/assets/courses-og-image.jpg'),
