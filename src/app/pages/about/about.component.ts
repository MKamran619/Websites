...
@Component({
  ...
  template: `
      ...
      <div class="container">
        <div class="hero-content">
          ...
          <p class="hero-subtitle">
            Nexa Web Services is a leading software development company passionate about
        ...
        <div class="philosophy-card">
          ...
          <div class="philosophy-author">
            <div class="author-info">
              <span class="author-name">Nexa Web Services Team</span>
    ...
    <section class="why-choose-section">
      <div class="container">
        <div class="section-header text-center">
          <span class="section-tag">Why Nexa Web Services?</span>
...
export class AboutComponent implements OnInit, AfterViewInit {
  ...
  milestones = [
    ...
    { year: "2024", title: "Nexa Web Services Founded" },
  ];
