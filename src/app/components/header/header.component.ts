              ...
              >
                ...
                <g filter="url(#softGlow)">
                  <text
                    ...
                    font-size="20"
                  ><tspan font-weight="700" fill="#1a202c">Nexa</tspan><tspan font-weight="700" fill="#4f8ef7">Web</tspan><tspan font-weight="300" fill="#718096" font-size="15" baseline-shift="-2"> Services</tspan></text>
                </g>
